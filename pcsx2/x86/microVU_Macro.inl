...
static void recCFC2()
{
    ...
    { // Divide TPC register value by 8 during copying
        ...
        // According to the official PS2 VU0 coding manual there are 3 ways to execute a micro subroutine on VU0
