...
#define mVUlogFtFs()                                            \
    {                                                           \
        mVUlog(".%s vf%02d, vf%02d", _XYZW_String, _Ft_, _Fs_); \
    }
#define mVUlogFd()                                              \
    {                                                           \
        mVUlog(".%s vf%02d, vf%02d", _XYZW_String, _Fd_, _Fs_); \
    }
#define mVUlogACC()                                    \
    {                                                  \
        mVUlog(".%s ACC, vf%02d", _XYZW_String, _Fs_); \
    }
#define mVUlogFt()                \
    {                             \
        mVUlog(", vf%02d", _Ft_); \
...
#define mVUlogBC()                              \
    {                                           \
        mVUlog(", vf%02d%s", _Ft_, _BC_String); \
    }
#define mVUlogI()      \
    {                  \
        mVUlog(", I"); \
...
#define mVUlogCLIP()                                 \
    {                                                \
        mVUlog("w.xyz vf%02d, vf%02dw", _Fs_, _Ft_); \
    }
