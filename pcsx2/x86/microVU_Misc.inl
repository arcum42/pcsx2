    ...
    if ((dest != src) && (xyzw != 0))
    {
        if (x86caps.hasStreamingSIMD4Extensions && (xyzw != 0x8) && (xyzw != 0xf))
        {
            if (modXYZW)
            {
                if (xyzw == 1)
                {
                    xINSERTPS(dest, src, _MM_MK_INSERTPS_NDX(0, 3, 0));
                    return;
                }
                else if (xyzw == 2)
                {
                    xINSERTPS(dest, src, _MM_MK_INSERTPS_NDX(0, 2, 0));
                    return;
                }
                else if (xyzw == 4)
                {
                    xINSERTPS(dest, src, _MM_MK_INSERTPS_NDX(0, 1, 0));
                    return;
                }
            }
        ...
        else
        {
            ...
            {
                case 1:
                    if (modXYZW) mVUunpack_xyzw(src, src, 0);
                ...
                case 5:
                    xSHUF.PS(dest, src, 0xd8);
                    xPSHUF.D(dest, dest, 0xd8);
                    break;

                case 6:
                    xSHUF.PS(dest, src, 0x9c);
                ...
                case 9:
                    xSHUF.PS(dest, src, 0xc9);
                    xPSHUF.D(dest, dest, 0xd2);
                    break;

                case 10:
                    xSHUF.PS(dest, src, 0x8d);
