...
void _recvuTestPipes(VURegs *VU, bool intermediate)
{ // intermediate = true if called by upper FMAC stall detection
...
void _recvuTestIALUStalls(VURegs *VU, _VURegsNum *VUregsn)
{
    ...
    for (i = 0; i < 16; i++)
    { // find used integer(vi00-vi15) registers
...
void _recvuAddFMACStalls(VURegs *VU, _VURegsNum *VUregsn)
{
    ...
    else if (VUregsn->VIwrite & (1 << REG_CLIP_FLAG))
        _recvuFMACAdd(VU, -REG_CLIP_FLAG, 0); // REG_CLIP_FLAG pipe
    else
        _recvuFMACAdd(VU, 0, 0); // cause no data dependency with fp registers
}
...
int eeVURecompileCode(VURegs *VU, _VURegsNum *regs)
{
    ...
    // alloc
    if (regs->VFread0)
        vfread0 = XMM_Reg.allocVF(VU, -1, regs->VFread0, MODE_READ);
    else if (regs->VIread & (1 << REG_VF0_FLAG))
        vfread0 = XMM_Reg.allocVF(VU, -1, 0, MODE_READ);
    if (regs->VFread1)
        vfread1 = XMM_Reg.allocVF(VU, -1, regs->VFread1, MODE_READ);
    else if ((regs->VIread & (1 << REG_VF0_FLAG)) && regs->VFr1xyzw != 0xff)
        vfread1 = XMM_Reg.allocVF(VU, -1, 0, MODE_READ);
    ...
    switch (xyzw)
    {
        ...
        case 1:
            if (x86caps.hasStreamingSIMD4Extensions)
                xINSERTPS(xRegisterSSE(dstreg), xRegisterSSE(srcreg), _MM_MK_INSERTPS_NDX(1, 0, 0));
            else
                xPSHUF.LW(xRegisterSSE(dstreg), xRegisterSSE(srcreg), 0xee);
            break;
        case 2: xMOVHL.PS(xRegisterSSE(dstreg), xRegisterSSE(srcreg)); break;
        case 3:
            if (x86caps.hasStreamingSIMD4Extensions)
                xINSERTPS(xRegisterSSE(dstreg), xRegisterSSE(srcreg), _MM_MK_INSERTPS_NDX(3, 0, 0));
            else
            {
                xMOVHL.PS(xRegisterSSE(dstreg), xRegisterSSE(srcreg));
                xPSHUF.LW(xRegisterSSE(dstreg), xRegisterSSE(dstreg), 0xee);
            }
            break;
    }
}
...
void _vuFlipRegSS(VURegs *VU, int reg)
{
    assert(_XYZW_SS);
    if (_Y)
        xPSHUF.LW(xRegisterSSE(reg), xRegisterSSE(reg), 0x4e);
    else if (_Z)
        xSHUF.PS(xRegisterSSE(reg), xRegisterSSE(reg), 0xc6);
    else if (_W)
        xSHUF.PS(xRegisterSSE(reg), xRegisterSSE(reg), 0x27);
}
...
void _vuMoveSS(VURegs *VU, int dstreg, int srcreg)
{
    assert(_XYZW_SS);
    if (_Y)
        _unpackVFSS_xyzw(dstreg, srcreg, 1);
    else if (_Z)
        _unpackVFSS_xyzw(dstreg, srcreg, 2);
    else if (_W)
        _unpackVFSS_xyzw(dstreg, srcreg, 3);
    else
        _unpackVFSS_xyzw(dstreg, srcreg, 0);
}

// 1 - src, 0 - dest				   wzyx
void VU_MERGE0(int dest, int src)
{ // 0000s
}
void VU_MERGE1(int dest, int src)
{ // 1000
    xMOVHL.PS(xRegisterSSE(src), xRegisterSSE(dest));
    xSHUF.PS(xRegisterSSE(dest), xRegisterSSE(src), 0xc4);
}
void VU_MERGE1b(int dest, int src)
{ // 1000s
...
void VU_MERGE2(int dest, int src)
{ // 0100
    xMOVHL.PS(xRegisterSSE(src), xRegisterSSE(dest));
    xSHUF.PS(xRegisterSSE(dest), xRegisterSSE(src), 0x64);
}
void VU_MERGE2b(int dest, int src)
{ // 0100s
...
void VU_MERGE7(int dest, int src)
{ // 1110
    xMOVSS(xRegisterSSE(src), xRegisterSSE(dest));
    xMOVAPS(xRegisterSSE(dest), xRegisterSSE(src));
}
void VU_MERGE7b(int dest, int src)
{ // 1110s
    xSHUF.PS(xRegisterSSE(dest), xRegisterSSE(src), 0xe4);
    xSHUF.PS(xRegisterSSE(src), xRegisterSSE(src), 0xE1);
    xSHUF.PS(xRegisterSSE(dest), xRegisterSSE(dest), 0xE1);
...
void VU_MERGE11(int dest, int src)
{ // 1101s
    xMOVSS(xRegisterSSE(dest), xRegisterSSE(src));
    xSHUF.PS(xRegisterSSE(dest), xRegisterSSE(src), 0xe4);
}
void VU_MERGE12(int dest, int src)
{ // 0011
    xMOVSD(xRegisterSSE(dest), xRegisterSSE(src));
}
void VU_MERGE13(int dest, int src)
{ // 1011
    xMOVHL.PS(xRegisterSSE(dest), xRegisterSSE(src));
    xSHUF.PS(xRegisterSSE(src), xRegisterSSE(dest), 0x64);
    xMOVAPS(xRegisterSSE(dest), xRegisterSSE(src));
}
void VU_MERGE13b(int dest, int src)
{ // 1011s
    xMOVSS(xRegisterSSE(dest), xRegisterSSE(src));
    xSHUF.PS(xRegisterSSE(src), xRegisterSSE(src), 0x27);
    xSHUF.PS(xRegisterSSE(dest), xRegisterSSE(dest), 0x27);
...
void VU_MERGE14(int dest, int src)
{ // 0111
    xMOVHL.PS(xRegisterSSE(dest), xRegisterSSE(src));
    xSHUF.PS(xRegisterSSE(src), xRegisterSSE(dest), 0xc4);
    xMOVAPS(xRegisterSSE(dest), xRegisterSSE(src));
}
void VU_MERGE14b(int dest, int src)
{ // 0111s
    xMOVSS(xRegisterSSE(dest), xRegisterSSE(src));
    xSHUF.PS(xRegisterSSE(src), xRegisterSSE(src), 0xE1);
    xSHUF.PS(xRegisterSSE(dest), xRegisterSSE(dest), 0xE1);
...
void VU_MERGE15(int dest, int src)
{ // 1111s
    xMOVAPS(xRegisterSSE(dest), xRegisterSSE(src));
}
...
void vFloat0(int regd, int regTemp)
{
} //0000
void vFloat1(int regd, int regTemp)
{ //1000
...
void vFloat1c(int regd, int regTemp)
{ //1000
    if (x86caps.hasStreamingSIMD4Extensions)
    {
        CLAMP_SIGN_SSE4(1);
...
void vFloat2(int regd, int regTemp)
{ //0100
...
void vFloat2c(int regd, int regTemp)
{ //0100
    if (x86caps.hasStreamingSIMD4Extensions)
    {
        CLAMP_SIGN_SSE4(2);
...
void vFloat3(int regd, int regTemp)
{ //1100
    xSHUF.PS(xRegisterSSE(regd), xRegisterSSE(regd), 0xc6);
    xMIN.SS(xRegisterSSE(regd), ptr[g_maxvals]);
    xMAX.SS(xRegisterSSE(regd), ptr[g_minvals]);
...
void vFloat3b(int regd, int regTemp)
{ //1100 //regTemp is Modified
...
void vFloat3c(int regd, int regTemp)
{ //1100
    if (x86caps.hasStreamingSIMD4Extensions)
    {
        CLAMP_SIGN_SSE4(3);
...
void vFloat4(int regd, int regTemp)
{ //0010
...
void vFloat4c(int regd, int regTemp)
{ //0010
    if (x86caps.hasStreamingSIMD4Extensions)
    {
        CLAMP_SIGN_SSE4(4);
...
void vFloat5(int regd, int regTemp)
{ //1010
    xPSHUF.LW(xRegisterSSE(regd), xRegisterSSE(regd), 0x4e);
    xMIN.SS(xRegisterSSE(regd), ptr[g_maxvals]);
    xMAX.SS(xRegisterSSE(regd), ptr[g_minvals]);
...
void vFloat5b(int regd, int regTemp)
{ //1010 //regTemp is Modified
    if (x86caps.hasStreamingSIMD4Extensions)
    {
        CLAMP_NORMAL_SSE4(5);
    }
...
void vFloat5c(int regd, int regTemp)
{ //1010
    if (x86caps.hasStreamingSIMD4Extensions)
    {
        CLAMP_SIGN_SSE4(5);
...
void vFloat6(int regd, int regTemp)
{ //0110
    xPSHUF.LW(xRegisterSSE(regd), xRegisterSSE(regd), 0x4e);
    xMIN.SS(xRegisterSSE(regd), ptr[g_maxvals]);
    xMAX.SS(xRegisterSSE(regd), ptr[g_minvals]);
...
void vFloat6b(int regd, int regTemp)
{ //0110 //regTemp is Modified
    if (x86caps.hasStreamingSIMD4Extensions)
    {
        CLAMP_NORMAL_SSE4(6);
    }
...
void vFloat6c(int regd, int regTemp)
{ //0110
    if (x86caps.hasStreamingSIMD4Extensions)
    {
        CLAMP_SIGN_SSE4(6);
...
void vFloat7(int regd, int regTemp)
{ //1110
    xPSHUF.LW(xRegisterSSE(regd), xRegisterSSE(regd), 0x4e);
    xMIN.SS(xRegisterSSE(regd), ptr[g_maxvals]);
    xMAX.SS(xRegisterSSE(regd), ptr[g_minvals]);
...
void vFloat7_useEAX(int regd, int regTemp)
{ //1110 //EAX is Modified
...
void vFloat7b(int regd, int regTemp)
{ //1110 //regTemp is Modified
    xMOVSS(xRegisterSSE(regTemp), xRegisterSSE(regd));
    xMIN.PS(xRegisterSSE(regd), ptr[g_maxvals]);
    xMAX.PS(xRegisterSSE(regd), ptr[g_minvals]);
    xMOVSS(xRegisterSSE(regd), xRegisterSSE(regTemp));
}
void vFloat7c(int regd, int regTemp)
{ //1110
    if (x86caps.hasStreamingSIMD4Extensions)
    {
        CLAMP_SIGN_SSE4(7);
...
void vFloat7c_useEAX(int regd, int regTemp)
{ //1110 //EAX is Modified
    if (x86caps.hasStreamingSIMD4Extensions)
    {
        CLAMP_SIGN_SSE4(7);
...
void vFloat8(int regd, int regTemp)
{ //0001
    xMIN.SS(xRegisterSSE(regd), ptr[g_maxvals]);
    xMAX.SS(xRegisterSSE(regd), ptr[g_minvals]);
}
void vFloat8c(int regd, int regTemp)
{ //0001
    if (x86caps.hasStreamingSIMD4Extensions)
    {
        CLAMP_SIGN_SSE4(8);
...
void vFloat9(int regd, int regTemp)
{ //1001
    xMIN.SS(xRegisterSSE(regd), ptr[g_maxvals]);
    xMAX.SS(xRegisterSSE(regd), ptr[g_minvals]);
    xSHUF.PS(xRegisterSSE(regd), xRegisterSSE(regd), 0x27);
...
void vFloat9b(int regd, int regTemp)
{ //1001 //regTemp is Modified
    if (x86caps.hasStreamingSIMD4Extensions)
    {
        CLAMP_NORMAL_SSE4(9);
    }
...
void vFloat9c(int regd, int regTemp)
{ //1001
    if (x86caps.hasStreamingSIMD4Extensions)
    {
        CLAMP_SIGN_SSE4(9);
...
void vFloat10(int regd, int regTemp)
{ //0101
    xMIN.SS(xRegisterSSE(regd), ptr[g_maxvals]);
    xMAX.SS(xRegisterSSE(regd), ptr[g_minvals]);
    xSHUF.PS(xRegisterSSE(regd), xRegisterSSE(regd), 0xc6);
...
void vFloat10b(int regd, int regTemp)
{ //0101 //regTemp is Modified
    if (x86caps.hasStreamingSIMD4Extensions)
    {
...
void vFloat10c(int regd, int regTemp)
{ //0101
    if (x86caps.hasStreamingSIMD4Extensions)
    {
        CLAMP_SIGN_SSE4(10);
...
void vFloat11(int regd, int regTemp)
{ //1101
    xMIN.SS(xRegisterSSE(regd), ptr[g_maxvals]);
    xMAX.SS(xRegisterSSE(regd), ptr[g_minvals]);
    xSHUF.PS(xRegisterSSE(regd), xRegisterSSE(regd), 0xc6);
...
void vFloat11_useEAX(int regd, int regTemp)
{ //1101 //EAX is Modified
    xPSHUF.LW(xRegisterSSE(regd), xRegisterSSE(regd), 0x4e);
    xMOVD(eax, xRegisterSSE(regd));
    xMIN.PS(xRegisterSSE(regd), ptr[g_maxvals]);
    xMAX.PS(xRegisterSSE(regd), ptr[g_minvals]);
...
void vFloat11b(int regd, int regTemp)
{ //1101 //regTemp is Modified
    xMOVAPS(xRegisterSSE(regTemp), xRegisterSSE(regd));
    xMIN.PS(xRegisterSSE(regd), ptr[g_maxvals]);
    xMAX.PS(xRegisterSSE(regd), ptr[g_minvals]);
    xMOVSS(xRegisterSSE(regTemp), xRegisterSSE(regd));
...
void vFloat11c(int regd, int regTemp)
{ //1101
    if (x86caps.hasStreamingSIMD4Extensions)
    {
        CLAMP_SIGN_SSE4(11);
...
void vFloat11c_useEAX(int regd, int regTemp)
{ //1101 // EAX is modified
    if (x86caps.hasStreamingSIMD4Extensions)
    {
        CLAMP_SIGN_SSE4(11);
...
void vFloat12(int regd, int regTemp)
{ //0011
    xMIN.SS(xRegisterSSE(regd), ptr[g_maxvals]);
    xMAX.SS(xRegisterSSE(regd), ptr[g_minvals]);
    xPSHUF.LW(xRegisterSSE(regd), xRegisterSSE(regd), 0x4e);
...
void vFloat13(int regd, int regTemp)
{ //1011
    xMIN.SS(xRegisterSSE(regd), ptr[g_maxvals]);
    xMAX.SS(xRegisterSSE(regd), ptr[g_minvals]);
    xPSHUF.LW(xRegisterSSE(regd), xRegisterSSE(regd), 0x4e);
...
void vFloat13_useEAX(int regd, int regTemp)
{ //1011 // EAX is modified
    xSHUF.PS(xRegisterSSE(regd), xRegisterSSE(regd), 0xc6);
    xMOVD(eax, xRegisterSSE(regd));
    xMIN.PS(xRegisterSSE(regd), ptr[g_maxvals]);
    xMAX.PS(xRegisterSSE(regd), ptr[g_minvals]);
...
void vFloat13b(int regd, int regTemp)
{ //1011 //regTemp is Modified
    xMOVAPS(xRegisterSSE(regTemp), xRegisterSSE(regd));
    xMIN.PS(xRegisterSSE(regd), ptr[g_maxvals]);
    xMAX.PS(xRegisterSSE(regd), ptr[g_minvals]);
    xMOVHL.PS(xRegisterSSE(regTemp), xRegisterSSE(regd));
...
void vFloat13c(int regd, int regTemp)
{ //1011
    if (x86caps.hasStreamingSIMD4Extensions)
    {
        CLAMP_SIGN_SSE4(13);
...
void vFloat13c_useEAX(int regd, int regTemp)
{ //1011 // EAX is modified
    if (x86caps.hasStreamingSIMD4Extensions)
    {
        CLAMP_SIGN_SSE4(13);
...
void vFloat14(int regd, int regTemp)
{ //0111
    xMIN.SS(xRegisterSSE(regd), ptr[g_maxvals]);
    xMAX.SS(xRegisterSSE(regd), ptr[g_minvals]);
    xPSHUF.LW(xRegisterSSE(regd), xRegisterSSE(regd), 0x4e);
...
void vFloat14_useEAX(int regd, int regTemp)
{ //0111 // EAX is modified
    xSHUF.PS(xRegisterSSE(regd), xRegisterSSE(regd), 0x27);
    xMOVD(eax, xRegisterSSE(regd));
    xMIN.PS(xRegisterSSE(regd), ptr[g_maxvals]);
    xMAX.PS(xRegisterSSE(regd), ptr[g_minvals]);
...
void vFloat14b(int regd, int regTemp)
{ //0111 //regTemp is Modified
    xMOVAPS(xRegisterSSE(regTemp), xRegisterSSE(regd));
    xMIN.PS(xRegisterSSE(regd), ptr[g_maxvals]);
    xMAX.PS(xRegisterSSE(regd), ptr[g_minvals]);
    xMOVHL.PS(xRegisterSSE(regTemp), xRegisterSSE(regd));
...
void vFloat14c(int regd, int regTemp)
{ //0111
    if (x86caps.hasStreamingSIMD4Extensions)
    {
        CLAMP_SIGN_SSE4(14);
...
void vFloat14c_useEAX(int regd, int regTemp)
{ //0111 // EAX is modified
    if (x86caps.hasStreamingSIMD4Extensions)
    {
        CLAMP_SIGN_SSE4(14);
...
void vFloat15(int regd, int regTemp)
{ //1111
    xMIN.PS(xRegisterSSE(regd), ptr[g_maxvals]);
    xMAX.PS(xRegisterSSE(regd), ptr[g_minvals]);
}
void vFloat15c(int regd, int regTemp)
{ //1111
    if (x86caps.hasStreamingSIMD4Extensions)
    {
        CLAMP_SIGN_SSE4(15);
